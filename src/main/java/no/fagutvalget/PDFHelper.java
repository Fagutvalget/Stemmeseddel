...
public class PDFHelper {
    ...
    public static PDPage getA4PortraitPage() {
        float POINTS_PER_INCH = 72;
        float POINTS_PER_MM = 1 / (10 * 2.54f) * POINTS_PER_INCH;
        return new PDPage(new PDRectangle(210 * POINTS_PER_MM, 297 * POINTS_PER_MM));
    }

    public static void writeTextCentered(PDPageContentStream contents, String string, PDFont font, int fontSize, float x, float y) throws IOException {
    ...
    public static void writeText(PDPageContentStream contents,String string, PDFont font, int fontSize, float x, float y) throws IOException {
        contents.setFont(font, fontSize);
        contents.beginText();
    ...
    public static void drawFilledRect(float x, float y,float w, float h, PDPageContentStream contents) throws IOException {
